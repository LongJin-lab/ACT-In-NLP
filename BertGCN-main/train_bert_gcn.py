...
parser.add_argument('--nb_epochs', type=int, default=50) #50
...
if args.opt==1:
    optimizer = th.optim.Adam_GAF([
        {'params': model.bert_model.parameters(), 'lr': bert_lr},
        {'params': model.classifier.parameters(), 'lr': bert_lr},
        {'params': model.gcn.parameters(), 'lr': gcn_lr},
    ], lr=1e-3,gamma=0.3,delta=4.5)
if args.opt==2:
    optimizer = th.optim.Adam_GAF([
        {'params': model.bert_model.parameters(), 'lr': bert_lr},
        {'params': model.classifier.parameters(), 'lr': bert_lr},
        {'params': model.gcn.parameters(), 'lr': gcn_lr},
    ], lr=1e-3,gamma=0.1,delta=20)
if args.opt==3:
    optimizer = th.optim.Adam_GAF([
        {'params': model.bert_model.parameters(), 'lr': bert_lr},
        {'params': model.classifier.parameters(), 'lr': bert_lr},
        {'params': model.gcn.parameters(), 'lr': gcn_lr},
    ], lr=1e-3,gamma=0.2,delta=10)
if args.opt==4:
    optimizer = th.optim.Adam_GAF([
        {'params': model.bert_model.parameters(), 'lr': bert_lr},
        {'params': model.classifier.parameters(), 'lr': bert_lr},
        {'params': model.gcn.parameters(), 'lr': gcn_lr},
    ], lr=1e-3,gamma=0.1,delta=15)
if args.opt==5:
    optimizer = th.optim.Adam_GAF([
        {'params': model.bert_model.parameters(), 'lr': bert_lr},
        {'params': model.classifier.parameters(), 'lr': bert_lr},
        {'params': model.gcn.parameters(), 'lr': gcn_lr},
    ], lr=1e-3,gamma=0.1,delta=30)
if args.opt==6:
    optimizer = th.optim.Adam_GAF([
        {'params': model.bert_model.parameters(), 'lr': bert_lr},
        {'params': model.classifier.parameters(), 'lr': bert_lr},
        {'params': model.gcn.parameters(), 'lr': gcn_lr},
    ], lr=1e-3,gamma=0.1,delta=40)
if args.opt==7:
    optimizer = th.optim.Adam_GAF([
        {'params': model.bert_model.parameters(), 'lr': bert_lr},
        {'params': model.classifier.parameters(), 'lr': bert_lr},
        {'params': model.gcn.parameters(), 'lr': gcn_lr},
    ], lr=1e-3,gamma=0.05,delta=30)
if args.opt==8:
    optimizer = th.optim.Adam_GAF([
        {'params': model.bert_model.parameters(), 'lr': bert_lr},
        {'params': model.classifier.parameters(), 'lr': bert_lr},
        {'params': model.gcn.parameters(), 'lr': gcn_lr},
    ], lr=1e-3,gamma=0.05,delta=40)
if args.opt==9:
    optimizer = th.optim.Adam_GAF([
        {'params': model.bert_model.parameters(), 'lr': bert_lr},
        {'params': model.classifier.parameters(), 'lr': bert_lr},
        {'params': model.gcn.parameters(), 'lr': gcn_lr},
    ], lr=1e-3,gamma=0.3,delta=7.5)
if args.opt==10:
    optimizer = th.optim.Adam_GAF([
        {'params': model.bert_model.parameters(), 'lr': bert_lr},
        {'params': model.classifier.parameters(), 'lr': bert_lr},
        {'params': model.gcn.parameters(), 'lr': gcn_lr},
    ], lr=1e-3,gamma=0.3,delta=10)
...
location='/media/qingchuan/BertGCN-main/log_'+str(args.gcn_model)+'/'+str(args.bert_init)+'/'+str(args.bert_init)+'.xlsx'
